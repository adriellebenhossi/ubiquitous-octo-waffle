        ...
        <div className="relative p-8">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">Sistema inteligente de destaque visual</p>
            </div>
          </div>

          {/* Explicação principal com visual aprimorado */}
          <div className="bg-white/70 backdrop-blur-sm rounded-xl p-6 border border-white/50 shadow-sm mb-6">
              ...
              <div className="flex-1">
                ...
                <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg p-4 border border-gray-200">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-sm font-medium text-gray-700">Sintaxe:</span>
                  </div>
                  <code className="bg-blue-100 px-3 py-1.5 rounded-md font-mono text-sm text-blue-800 border">
          ...
          {/* Impacto visual expandido */}
          <div className="bg-gradient-to-r from-amber-50/80 to-orange-50/80 backdrop-blur-sm rounded-xl p-6 border border-amber-200/50">
            <div className="flex items-start gap-4">
              <div className="flex-shrink-0 w-8 h-8 bg-gradient-to-r from-amber-100 to-orange-100 rounded-lg flex items-center justify-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <div className="bg-white/70 rounded-lg p-3 border border-amber-200/50">
                    <div className="flex items-center gap-2 mb-1">
                      <div className="w-4 h-4 rounded-full bg-gradient-to-r from-pink-500 to-purple-600"></div>
                      <span className="text-sm font-medium text-amber-800">Detalhes</span>
                    </div>
                  ...
                  <div className="bg-white/70 rounded-lg p-3 border border-amber-200/50">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="text-sm font-medium text-amber-800">Ênfases</span>
                    </div>
