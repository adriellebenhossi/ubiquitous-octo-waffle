...
Sistema de Contato Web`,
  ...
  return (
    <div className="space-y-6">
      <Card className="bg-gradient-to-br from-pink-50 via-purple-50 to-blue-50 border-2 border-pink-200/50 shadow-xl rounded-2xl overflow-hidden">
        <CardHeader className="pb-6 relative">
          {/* Decoração de fundo fofa */}
          <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-bl from-pink-200/30 to-transparent rounded-full -translate-y-8 translate-x-8"></div>
          <div className="absolute bottom-0 left-0 w-24 h-24 bg-gradient-to-tr from-purple-200/30 to-transparent rounded-full translate-y-8 -translate-x-8"></div>
          
          <CardTitle className="flex items-center gap-3 text-xl relative z-10">
            <div className="p-3 bg-gradient-to-r from-pink-400 via-purple-400 to-blue-400 rounded-2xl shadow-lg">
          ...
          <CardDescription className="text-sm leading-relaxed relative z-10 mt-3">
            <div className="bg-white/70 backdrop-blur-sm rounded-xl p-4 border border-pink-200/50">
              ...
              <div className="flex flex-wrap gap-2 text-xs">
                <span className="inline-flex items-center gap-1 bg-pink-100 text-pink-700 px-2 py-1 rounded-full">
                  🔒 Super privado
                </span>
        ...
        <CardContent className="p-6">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-pink-200/50 shadow-inner">
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <Select onValueChange={field.onChange} value={field.value}>
                            <SelectTrigger className="border-2 border-pink-200 rounded-xl bg-white/90 hover:border-pink-300 transition-all duration-200 h-12">
                              <SelectValue placeholder="💭 Como posso te ajudar hoje?" />
                            </SelectTrigger>
                            <SelectContent className="rounded-xl border-2 border-pink-200">
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <Textarea 
                            ...
                            rows={6}
                            className="resize-y border-2 border-pink-200 rounded-xl bg-white/90 hover:border-pink-300 transition-all duration-200 focus:border-purple-300"
                            {...field} 
                          />
                        </FormControl>
                        <div className="bg-gradient-to-r from-pink-100 to-purple-100 border border-pink-200 rounded-xl p-3 text-xs">
                          <div className="flex items-center gap-2 text-gray-600">
                            <span className="text-base">🔒</span>
                            <span>Sua privacidade está 100% protegida. Só eu vou ver esta mensagem e ela chegará no meu email pessoal rapidinho!</span>
                          </div>
                        </div>
                        <FormMessage />
                      </FormItem>
                  ...
                  <div className="space-y-4">
                    ...
                    {/* Área de Upload */}
                    <div className="border-2 border-dashed border-pink-300 rounded-2xl p-8 text-center hover:border-purple-400 transition-all duration-300 bg-gradient-to-br from-pink-50/50 to-purple-50/50">
                      <input
                        type="file"
                        accept="image/*"
                        multiple
                      ...
                      >
                        <div className="p-4 bg-gradient-to-r from-pink-400 to-purple-400 rounded-2xl">
                        ...
                        <div className="text-sm text-gray-600">
                          {uploadingFiles ? (
                            <div className="flex items-center gap-2">
                              ...
                              <span>Enviando suas fotos...</span>
                            </div>
                          ) : (
                            <>
                              <span className="font-medium text-purple-600 text-base">🌟 Clique para anexar suas fotos</span>
                              <br />
                              <span className="text-gray-500">ou arraste e solte aqui</span>
                            </>
                          )}
                        </div>
                        <div className="bg-white/80 backdrop-blur-sm rounded-xl px-3 py-2 text-xs text-gray-600 border border-pink-200">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 pt-6">
                    <Button 
                      ...
                      className="btn-admin flex items-center justify-center gap-3 h-14 rounded-2xl text-base"
                    >
                    ...
                    <div className="flex flex-col sm:flex-row gap-2">
                      <Button 
                        ...
                        variant="outline"
                        onClick={resetForm}
                        className="h-14 rounded-2xl border-2 border-pink-200 hover:border-pink-300 hover:bg-pink-50 transition-all duration-200 text-gray-700"
                      >
                        <span className="text-base">🔄 Limpar Texto</span>
                      </Button>
                      {attachedFiles.length > 0 && (
                        <Button 
                          type="button" 
                          variant="outline"
                          onClick={clearAll}
                          className="h-14 rounded-2xl border-2 border-red-200 hover:border-red-300 hover:bg-red-50 transition-all duration-200 text-red-600"
                        >
                          <span className="text-base">🗑️ Limpar Tudo</span>
                        </Button>
                      )}
                    </div>
                  </div>
