                        ...
                        <FormItem>
                          ...
                          <FormControl>
                            <Textarea
                              ...
                              className="min-h-80 sm:min-h-40 bg-white/10 border-white/20 text-white placeholder:text-gray-400 focus:border-purple-400 resize-y text-sm sm:text-base elegant-textarea clarity-unmask secret-input data-hj-allow"
                              style={{ 
                                color: '#ffffff !important',
                                WebkitTextFillColor: '#ffffff !important'
                              }}
