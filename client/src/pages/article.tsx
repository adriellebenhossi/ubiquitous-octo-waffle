        ...
        <div className="max-w-6xl mx-auto px-3 sm:px-6 py-3">
          ...
          <div className="hidden sm:flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              {article.category && (
                <Badge className="bg-gray-100 text-gray-700 hover:bg-gray-200 font-medium px-3 py-1 rounded-full text-xs tracking-wider uppercase border border-gray-200">
                  {article.category}
                </Badge>
              )}
          ...
          <div className="sm:hidden flex items-center justify-between">
            <div className="flex-1 flex justify-start">
              {article.category && (
                <Badge className="bg-gray-100 text-gray-700 hover:bg-gray-200 font-medium px-3 py-1 rounded-full text-xs uppercase border border-gray-200">
                  {article.category}
                </Badge>
              )}
            </div>
        ...
        <header className="mb-12">
          ...
          >
            ...
            <div className="flex items-center gap-4">
              {article.publishedAt && (
                <time className="text-xs text-gray-500 font-light tracking-wide">
