...
import { TrendingUp, Globe, Search, Upload, X, Eye, Code, Trash2, Plus, Target, Users, Zap, Smartphone, Monitor, Share2, Settings, ExternalLink, Archive, FileText, EyeOff, Brain, Filter, Ban } from "lucide-react";
import { SiFacebook, SiGoogle, SiInstagram, SiWhatsapp, SiLinkedin } from "react-icons/si";
  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto space-y-4 sm:space-y-6">
        ...
        <div className="bg-white/80 backdrop-blur-sm border border-gray-200/60 rounded-xl sm:rounded-2xl p-4 sm:p-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-gray-900 to-gray-700 rounded-xl flex items-center justify-center">
        ...
        <Tabs defaultValue="pixels" className="w-full">
          <div className="bg-white/80 backdrop-blur-sm border border-gray-200/60 rounded-xl sm:rounded-2xl p-2 sm:p-3">
            <TabsList className="grid w-full grid-cols-3 bg-gray-50/50 rounded-lg sm:rounded-xl h-auto p-1">
              <TabsTrigger 
                value="pixels" 
                className="flex-1 flex flex-col sm:flex-row items-center gap-2 py-3 sm:py-2 px-2 sm:px-4 data-[state=active]:bg-white data-[state=active]:shadow-sm rounded-md sm:rounded-lg text-xs sm:text-sm font-medium transition-all"
              >
                <Target className="w-4 h-4 flex-shrink-0" />
                <span className="text-center sm:text-left">Pixels</span>
              </TabsTrigger>
              <TabsTrigger 
                value="seo" 
                className="flex-1 flex flex-col sm:flex-row items-center gap-2 py-3 sm:py-2 px-2 sm:px-4 data-[state=active]:bg-white data-[state=active]:shadow-sm rounded-md sm:rounded-lg text-xs sm:text-sm font-medium transition-all"
              >
                ...
                <span className="text-center sm:text-left">SEO</span>
              </TabsTrigger>
              <TabsTrigger 
                value="codes" 
                className="flex-1 flex flex-col sm:flex-row items-center gap-2 py-3 sm:py-2 px-2 sm:px-4 data-[state=active]:bg-white data-[state=active]:shadow-sm rounded-md sm:rounded-lg text-xs sm:text-sm font-medium transition-all"
              >
                ...
                <span className="text-center sm:text-left">Códigos</span>
              </TabsTrigger>
            </TabsList>
          </div>

          {/* Aba de Pixels */}
          <TabsContent value="pixels" className="space-y-4 sm:space-y-6 mt-4 sm:mt-6">
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 sm:space-y-6">
                {/* Card de Pixels */}
                <div className="bg-white/80 backdrop-blur-sm border border-gray-200/60 rounded-xl sm:rounded-2xl overflow-hidden">
                  <div className="border-b border-gray-200/60 p-4 sm:p-6">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 bg-blue-100 rounded-lg flex items-center justify-center">
                        <Target className="w-4 h-4 text-blue-600" />
                      </div>
                      <div>
                        <h3 className="text-lg font-semibold text-gray-900">Pixels de Rastreamento</h3>
                        <p className="text-sm text-gray-600">Configure Facebook e Google Analytics</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-4 sm:p-6 space-y-6">
                            ...
                            <FormItem>
                              ...
                              <FormControl>
                                <Input
                                  ...
                                  {...field}
                                  className="bg-gray-50/50 border-gray-200 focus:border-gray-400 focus:ring-0 transition-colors"
                                />
                              </FormControl>
                              <FormMessage />
                            </FormItem>
                                ...
                                <div className="flex items-center gap-3">
                                  ...
                                  <div>
                                    ...
                                    <div className="text-xs text-gray-600">
                                      Permitir que o site apareça nos resultados de busca
                                    </div>
                                  </div>
                                </div>
                                <FormControl>
                    ...
                    <div className="border-t border-gray-200/60 pt-6">
                      <Button 
                        ...
                        className="btn-admin w-full sm:w-auto sm:min-w-[160px] h-10 sm:h-11 text-sm font-medium"
                      >
                ...
                <div className="bg-white/80 backdrop-blur-sm border border-gray-200/60 rounded-xl sm:rounded-2xl overflow-hidden">
                  <div className="border-b border-gray-200/60 p-4 sm:p-6">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="text-lg font-semibold text-gray-900">SEO e Meta Tags</h3>
                        <p className="text-sm text-gray-600">Como seu site aparece no Google e redes sociais</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-4 sm:p-6 space-y-6">
                          ...
                          <FormItem>
                            ...
                            <FormControl>
                              <Textarea
                                {...field}
                                rows={3}
                                className="bg-gray-50/50 border-gray-200 focus:border-gray-400 focus:ring-0 transition-colors resize-none"
                              />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input
                                {...field}
                                placeholder="psicóloga, terapia, saúde mental"
                                className="bg-gray-50/50 border-gray-200 focus:border-gray-400 focus:ring-0 transition-colors"
                              />
                            </FormControl>
                            <FormMessage />
                    ...
                    <div className="border-t border-gray-200/60 pt-6 space-y-4">
                      <div className="flex items-center gap-3">
                        ...
                        <h4 className="font-medium text-gray-900">Redes Sociais (Open Graph)</h4>
                      </div>
                            ...
                            <div className="text-center">
                              ...
                              <div className="mb-4">
                                ...
                                <p className="text-xs text-gray-500">
                                  1200×630px recomendado, máx. 5MB
                                </p>
                              </div>
                              <label className="btn-admin cursor-pointer inline-flex items-center gap-2 px-4 py-2 text-sm">
                        ...
                        <div className="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm">
                          <div className="bg-blue-600 px-4 py-2">
                            <div className="flex items-center gap-2 text-white">
                              ...
                              <span className="text-sm font-medium">Facebook / WhatsApp</span>
                            </div>
                          </div>
                          ...
                          <div className="p-4">
                            ...
                            <p className="text-sm text-gray-600 line-clamp-3">
                              {form.watch("ogDescription") || form.watch("metaDescription") || "Descrição que aparecerá quando o link for compartilhado..."}
                            </p>
                          </div>
                        </div>
                      </div>
          ...
          {/* Aba de Códigos Customizados */}
          <TabsContent value="codes" className="space-y-4 sm:space-y-6 mt-4 sm:mt-6">
            <div className="bg-white/80 backdrop-blur-sm border border-gray-200/60 rounded-xl sm:rounded-2xl overflow-hidden">
              <div className="border-b border-gray-200/60 p-4 sm:p-6">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900">Códigos Personalizados</h3>
                      <p className="text-sm text-gray-600">Scripts customizados para head e body</p>
                    </div>
                  </div>
                  <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                    <DialogTrigger asChild>
                      <Button className="btn-admin h-9 text-sm">
                        <Plus className="w-4 h-4 mr-2" />
                        Novo Código
                      </Button>
                    </DialogTrigger>
                    <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
                      <DialogHeader>
                        ...
                        <DialogDescription>
                          Adicione scripts personalizados ao seu site
                        </DialogDescription>
                      </DialogHeader>
                      
                      <Form {...codeForm}>
                        <form onSubmit={codeForm.handleSubmit(handleSaveCode)} className="space-y-4">
                          <FormField
                            control={codeForm.control}
                            name="name"
                            render={({ field }) => (
                              <FormItem>
                                <FormLabel>Nome do Código</FormLabel>
                                <FormControl>
                                  <Input {...field} placeholder="Ex: Google Analytics" />
                                </FormControl>
                                <FormMessage />
                              </FormItem>
                            )}
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <Select onValueChange={field.onChange} defaultValue={field.value}>
                                  ...
                                  <SelectContent>
                                    <SelectItem value="header">Header (recomendado)</SelectItem>
                              ...
                              <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                                <div className="space-y-0.5">
                                  ...
                                  <div className="text-sm text-gray-600">
                                    O código será inserido no site quando ativado
                                  </div>
                                </div>
                                <FormControl>
                                  <Switch
                          ...
                          <div className="flex flex-col sm:flex-row gap-3 pt-4 border-t">
                            <Button 
                              type="submit" 
                              disabled={codeFormMutation.isPending}
                              className="btn-admin flex-1 sm:flex-none sm:min-w-[120px]"
                            >
                              {codeFormMutation.isPending ? "Salvando..." : "Salvar"}
                            </Button>
                            <Button 
                              type="button" 
                              variant="outline" 
                ...
                {customCodes.length === 0 ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-600 mb-4">
                      Adicione scripts customizados para integrar ferramentas de marketing
                    </p>
                  </div>
                ) : (
                  <div className="space-y-3">
                    {customCodes.map((code) => (
                      <div key={code.id} className="bg-gray-50/50 rounded-lg p-4 border border-gray-200">
...
// Componente para renderizar os códigos customizados
const renderCustomCodesSection = (title: string, codes: any[], icon: React.ReactNode) => (
    <div className="space-y-3">
      <div className="flex items-center gap-2">
        {icon}
      ...
      {codes.length === 0 ? (
        <div className="bg-gray-50/50 rounded-lg p-4 text-center">
          <p className="text-sm text-gray-600">Nenhum código configurado</p>
        </div>
      ) : (
        <DragAndDropContainer
          items={codes}
        ...
        >
          {codes.map((code) => (
            <div key={code.id} className="bg-white rounded-lg border border-gray-200 p-3">
              <div className="flex items-start justify-between gap-3">
                <div className="flex-1 min-w-0">
